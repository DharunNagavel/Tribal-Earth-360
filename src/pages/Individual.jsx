...
const Individual = () => {
  ...
  // Update filtered panchayats when tehsil changes
  useEffect(() => {
    ...
    // Reset dependent fields when tehsil changes
    setFormData(prev => ({
      ...prev,
      gramPanchayat: '',
      village: ''
  ...
  // Update filtered villages when gramPanchayat changes
  useEffect(() => {
    ...
    // Reset dependent fields when gramPanchayat changes
    setFormData(prev => ({
      ...prev,
      village: ''
    }));
          ...
          {currentSection === 3 && (
            <div className="border border-green-300 rounded-lg p-5 bg-green-50 mb-6">
              ...
              <div className="mb-6">
                ...
                <p><strong>Traditional Forest Dweller:</strong> {formData.traditionalForestDweller || 'Not provided'}</p>
