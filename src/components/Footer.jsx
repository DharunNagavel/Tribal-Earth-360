...
export const Footer = () => {
  return (
    <div>
      <footer className="bg-[#78C6A3]  text-white pt-10 pb-6 border-t border-gray-600">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row justify-between gap-6">
          <div>
            ...
            <ul className="space-y-1 text-sm">
              <li><a href="/" className="hover:text-[#800000]">Home</a></li>
              <li><a href="/individual" className="hover:text-[#800000]">Patta</a></li>
              <li><a href="/map" className="hover:text-[#800000]">Map</a></li>
              <li><a href="/about" className="hover:text-[#800000]">About FRA</a></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-3">
              <a href="/" target="_blank" rel="noreferrer" className="text-white hover:text-[#800000]">
                <Facebook size={20} />
              </a>
              <a href="/" target="_blank" rel="noreferrer" className="text-white hover:text-[#800000]">
                <Instagram size={20} />
